            ...
            <div class="row">
                <div class="col-md-12   ">
				 ...
				 <div class="booking-box">
                       ...
                       <p>Transaction Status : <asp:Label ID="Label1" runat="server" Text="Label" BackColor="#339933" Font-Bold="True" Font-Italic="True" Font-Size="Medium" ForeColor="White"></asp:Label></p> 
                         <p>Transaction ID : <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></p> 
                           <p>easepayid : <asp:Label ID="Label3" runat="server" Text="Label" Visible="False"></asp:Label></p> 
                            <p>Total Amount : <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></p> 
                             <p>Room Category : <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label></p> 
                              <p>Client Name : <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></p> 
                               <p>Email : <asp:Label ID="Label7" runat="server" Text="Label"></asp:Label></p> 
                               <p>Contact No. : <asp:Label ID="Label8" runat="server" Text="Label"></asp:Label></p> 
                               <p>hash : <asp:Label ID="Label9" runat="server" Text="Label" Visible="False"></asp:Label></p> 

                               <p>BookingID : <asp:Label ID="Label10" runat="server" Text="Label"></asp:Label></p> 
                               <p>CheckIn  : <asp:Label ID="Label11" runat="server" Text="Label"></asp:Label></p> 
                               <p>CheckOut : <asp:Label ID="Label12" runat="server" Text="Label"></asp:Label></p> 
