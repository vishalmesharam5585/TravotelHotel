            ...
            <div class="row">
                <div class="col-md-12   ">
				 ...
				 <div class="booking-box">
                       ...
                       <p>Transaction Status : <asp:Label ID="Label1" runat="server" Text="Label" BackColor="Red" Font-Bold="True" Font-Italic="False" Font-Size="Medium" ForeColor="White"></asp:Label></p> 
                         <p>Transaction ID : <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></p> 
                          <%-- <p>easepayid : <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></p> --%>
                            <p>Total Amount : <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></p> 
                             <p>Room Category : <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label></p> 
                              <p>Client Name : <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></p> 
                               ...
                               <%--<p>hash : <asp:Label ID="Label9" runat="server" Text="Label"></asp:Label></p> --%>
