<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deluxe_booking_checkout.aspx.cs" Inherits="deluxe_booking_checkout" %>
                        ...
                        <div class="##">
                            ...
                            <table style="border-top-color: #FFFFFF">
                                <tr class="col-md-4">
                                    ...
                                    <td>
                                        <p>&nbsp &nbsp <asp:Label ID="lblcharges" runat="server" Text="6000.00"></asp:Label></p>
                                    </td>
                                ...
                                <tr class="col-md-4">
                                    ...
                                    <td>
                                        <p> &nbsp &nbsp <asp:Label ID="lblgst" runat="server" Text="300.00"> </asp:Label></p>
                                    </td>
                                 ...
                                 <tr class="col-md-4">
                                    ...
                                    <td>
                                        <p> &nbsp &nbsp <asp:Label ID="lbltotal" runat="server" Text="6300.00"> </asp:Label></p>
                                    </td>
