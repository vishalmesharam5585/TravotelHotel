<%@ Page Language="C#" AutoEventWireup="true" CodeFile="suite_book.aspx.cs" Inherits="suite_book" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
					...
					<div class="room_d_main_text">
                                <div class="room_details_img owl-carousel" style="width: 700px; ">
                                    <div class="item">
                                     <img src="img/Suite%20rooms/1.JPG" />
                                    </div>
                                    <div class="item">
                                      <img src="img/Suite%20rooms/2.JPG" />
                                    </div>
                                    <div class="item">
                                       <img src="img/Suite%20rooms/3.JPG" />
                                    </div>
                                     <div class="item">
                                        <img src="img/Suite%20rooms/4.JPG" />
                                    </div>
									 <div class="item">
                                      <img src="img/Suite%20rooms/5.JPG" />
                                    </div>

                                     <div class="item">
                                      <img src="img/Suite%20rooms/6.JPG" />
                                    </div>

                                     <div class="item">
                                      <img src="img/Suite%20rooms/7.JPG" />
                                    </div>
                                </div>
								</div>
				...
				<div class="section-subtitle">The Travotel Hotel</div>
                    <div class="section-title">The Suite Room</div>
                    <p>The styled decor of Suite  offers a great sense of warmth & coziness. Find yourself in an environment of uncompromising comfort and splendid view. A sophisticated bedroom entices you to relax in luxury. Enjoy a complimentary beverage on arrival. Soothe your tired muscles with a shower in our luxuriously appointed bathroom equipped with bath tub. The chic décor & state of art amenities make your stay a sheer joy. Make a stop in our Suite & avail the ace hospitality services that we offer</p>
                   
                      
                       
                            <h6>Room Size</h6>
                            <p>The size of the Suite Room is around 240 sq. ft. It features a King Bed and offers a road view.</p>

                            <h6>Room Amenities</h6>
                            <p>Bottled Water, Tea/Coffee maker with suplies, Daily housekeeping, In Room Dining, LED TV, AC., Iron / Ironing Board</p>

                            <h6>Room Features</h6>
                            <p>Study Table with Reading Lamp, Closet, Mirror, Hangers, Sofa, Chair, Intercom</p>

                             <h6>Bathroom Have</h6>
                            <p>Bathtub, Shaving Mirror,Bubble Bath,  Geyser Shower Cap, Western Toilet Seat, Shower Cubicles, Dustbins, Toilet Paper, Shower Toiletries, Towels</p>
