<%@ Page Language="C#" AutoEventWireup="true" CodeFile="standard_book.aspx.cs" Inherits="standard_book" %>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
					...
					<div class="room_d_main_text">
                                <div class="room_details_img owl-carousel" style="width: 700px; ">
                                    ...
                                    <div class="item">
                                         <img src="img/Standard%20rooms/3.JPG" />
                                    </div>
                                     <div class="item">
                                        <img src="img/Standard%20rooms/4.JPG" />
                                    </div>
									 <div class="item">
                                        <img src="img/Standard%20rooms/5.JPG" />
                                    </div>


                                     <div class="item">
                                        <img src="img/Standard%20rooms/6.JPG" />
                                    </div>

                                     <div class="item">
                                        <img src="img/Standard%20rooms/7.JPG" />
                                    </div>

                                     <div class="item">
                                        <img src="img/Standard%20rooms/8.JPG" />
                                    </div>

                                     <div class="item">
                                        <img src="img/Standard%20rooms/9.JPG" />
                                    </div>

                                     <div class="item">
                                        <img src="img/Standard%20rooms/10.JPG" />
                                    </div>

                                     <div class="item">
                                        <img src="img/Standard%20rooms/11.JPG" />
                                    </div>

                                     <div class="item">
                                        <img src="img/Standard%20rooms/12.JPG" />
                                    </div>

                                      <div class="item">
                                        <img src="img/Standard%20rooms/1.JPG" />
                                    </div>
                                    <div class="item">
                                         <img src="img/Standard%20rooms/2.JPG" />
                                    </div>
				...
				<div class="section-subtitle">The Travotel Hotel</div>
                    <div class="section-title">Standard Room</div>
                    <p>The styled decor of Standard Room offers a great sense of warmth & coziness. Find yourself in an environment of uncompromising comfort and splendid view. A sophisticated bedroom entices you to relax in luxury. Enjoy a complimentary beverage on arrival. Soothe your tired muscles with a shower in our luxuriously appointed bathroom. The chic décor & state of art amenities make your stay a sheer joy. Make a stop in our Standard Room & avail the ace hospitality services that we offer</p>
                   
                      
                       
                            <h6>Room Size</h6>
                            <p>The size of the Standard Room is around 150 sq. ft. It offers both Twin Bed and King Bed options.</p>

                            <h6>Room Amenities</h6>
                            <p>Bottled Water, Tea/Coffee maker with suplies, Daily housekeeping, In Room Dining, LED TV, AC. </p>

                            <h6>Room Features</h6>
                            <p>Study Table wit Reading Lamp, Closet, Mirror, Hangers, Chair, Intercom</p>
