...
public partial class standard_book : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("standard_room.aspx?checkin=" + txtCheckIn.Text + "&checkout=" + txtCheckOut.Text + "&adult=" + DropDownList1.SelectedItem.Text + "&children=" + DropDownList2.SelectedItem.Text + "");
    }
