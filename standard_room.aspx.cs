...
public partial class standard_room : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (DropDownList2.SelectedItem.Text == "") { lblchilds.Visible = true; DropDownList2.Focus(); return; } else { lblchilds.Visible = false; }
            ...
            Response.Redirect("standard_booking_checkout.aspx?checkin=" + txtCheckIn.Text + "&checkout=" + txtCheckOut.Text + "&adult=" + DropDownList1.SelectedItem.Text + "&children=" + DropDownList2.SelectedItem.Text + "&room=" + DropDownList3.SelectedItem.Text + "&guest=" + txtGuest.Text + "&address=" + txtAddress.Text + "&state=" + DropDownList4.SelectedItem.Text + "&city=" + txtcity.Text + "&email=" + txtemail.Text + "&contact=" + txtcontact.Text + "&ExtraBed=" + DropDownList5.SelectedItem.Text + "&ExtraMat=" + DropDownList6.SelectedItem.Text + "");
        }
    }
