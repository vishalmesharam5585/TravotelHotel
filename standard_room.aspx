<%@ Page Language="C#" AutoEventWireup="true" CodeFile="standard_room.aspx.cs" Inherits="standard_room" %>
				 ...
				 <div class="booking-box">
                            ...
                            <div class="booking-inner clearfix">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input1_wrapper">
                                                <label>Meal Plan</label><asp:Label ID="lblMeal" runat="server" Text="*" Font-Size="XX-Large" ForeColor="#FF0066" Font-Bold="True" Visible="False"></asp:Label>
                                                <div class="select1_inner">
                                                    <asp:DropDownList ID="DropDownList7" runat="server" class="select2 select">
                                                    <asp:ListItem Text="Select" Value=""></asp:ListItem>
                                                      <asp:ListItem Text="With Breakfast" Value="0"></asp:ListItem>
                                                      <asp:ListItem Text="Without Breakfast " Value="1"></asp:ListItem>
                                                      <asp:ListItem Text="With Breakfast & Dinner" Value="2"></asp:ListItem>
                                                      <asp:ListItem Text="With Breakfast, Lunch & Dinner" Value="3"></asp:ListItem>
                                                </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-4">
                                            <div class="input1_wrapper">
                                                <label>Extra Guest</label><asp:Label ID="Label1" runat="server" Text="*" Font-Size="XX-Large" ForeColor="#FF0066" Font-Bold="True" Visible="False"></asp:Label>
                                                <div class="select1_inner">
                                                    <asp:DropDownList ID="DropDownList5" runat="server" class="select2 select">
                                            ...
                                            <div class="col-md-4">
                                            <div class="input1_wrapper">
                                                <label>Extra Mattresses</label><asp:Label ID="Label2" runat="server" Text="*" Font-Size="XX-Large" ForeColor="#FF0066" Font-Bold="True" Visible="False"></asp:Label>
                                                <div class="select1_inner">
                                                    <asp:DropDownList ID="DropDownList6" runat="server" class="select2 select">
