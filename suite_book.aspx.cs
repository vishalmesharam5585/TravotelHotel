...
public partial class suite_book : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("suite_room.aspx?checkin=" + txtCheckIn.Text + "&checkout=" + txtCheckOut.Text + "&adult=" + DropDownList1.SelectedItem.Text + "&children=" + DropDownList2.SelectedItem.Text + "");
    }
